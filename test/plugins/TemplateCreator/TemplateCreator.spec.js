...
/**
 * Generated by PluginGenerator 0.14.0 from webgme on Sat Sep 26 2015 03:32:07 GMT-0500 (CDT).
 */

'use strict';
var testFixture = require('../../globals');

// This is tested in the ExamplePlugin
describe.skip('TemplateCreator', function () {
    var gmeConfig = testFixture.getGmeConfig(),
        expect = testFixture.expect,
        logger = testFixture.logger.fork('NewPlugin'),
        PluginCliManager = testFixture.WebGME.PluginCliManager,
        projectName = 'testProject',
        pluginName = 'TemplateCreator',
        project,
        gmeAuth,
        storage,
        commitHash;
